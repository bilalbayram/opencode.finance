...
export function projectDatasetSnapshots(input: {
...
export function assertRequiredDatasets(input: {
...
export function sourceAttributionLines(snapshots: DatasetSnapshot[]) {
    return snapshots
        .toSorted((a, b) => {
...
export function buildDashboardMarkdown(input: {
    mode: ReportGovernmentTradingMode
    scope: string
    generatedAt: string
    runId: string
